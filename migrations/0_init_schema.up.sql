...
CREATE TABLE commit_ts_2025_04 PARTITION OF commit_staging
    FOR VALUES FROM ('2025-04-01') TO ('2025-05-01');

CREATE TABLE commit_ts_2025_05 PARTITION OF commit_staging
    FOR VALUES FROM ('2025-05-01') TO ('2025-06-01');

CREATE TABLE commit_ts_2025_06 PARTITION OF commit_staging
    FOR VALUES FROM ('2025-06-01') TO ('2025-07-01');

CREATE TABLE commit_ts_2025_07 PARTITION OF commit_staging
    FOR VALUES FROM ('2025-07-01') TO ('2025-08-01');

CREATE TABLE commit_ts_2025_08 PARTITION OF commit_staging
    FOR VALUES FROM ('2025-08-01') TO ('2025-09-01');

CREATE TABLE commit_ts_2025_09 PARTITION OF commit_staging
    FOR VALUES FROM ('2025-09-01') TO ('2025-10-01');

CREATE TABLE commit_ts_2025_10 PARTITION OF commit_staging
    FOR VALUES FROM ('2025-10-01') TO ('2025-11-01');

CREATE TABLE commit_ts_2025_11 PARTITION OF commit_staging
    FOR VALUES FROM ('2025-11-01') TO ('2025-12-01');

CREATE TABLE commit_ts_2025_12 PARTITION OF commit_staging
